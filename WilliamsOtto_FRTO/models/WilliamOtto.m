function [sys,par,F] = WilliamOtto(Ts)
%
...
sys.diff = vertcat(dxa,dxb,dxc,dxp,dxe,dxg,dTr);
...
par.lbx = [zeros(6,1);20+273];
par.ubx = [1.*ones(6,1);473];
par.lbu = [2];
par.ubu = [7];
par.dx0 = [1;1;1;1.0;1.0;1.0;373];
par.u0 = [0];